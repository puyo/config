...
(custom-set-variables
 ...
 '(projectile-globally-ignored-directories '(".idea" ".eunit" ".git" ".hg" ".fslckout" ".bzr" "_darcs" ".tox" ".svn" ".stack-work" "node_modules"))
 '(projectile-globally-ignored-files '("TAGS" "tags" ".tern-port"))
 '(projectile-use-git-grep t)
 '(recentf-exclude '("COMMIT_EDITMSG\\'" "/Users/greg/.emacs.d/elpa" "/Users/greg/.emacs.d/.cache/" "TAGS"))
